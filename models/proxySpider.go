...
type TaskToDoList struct {
	gorm.Model
	TaskType   string `gorm:"size:255;notnull" json:"task_type"`
	TaskParams string `gorm:"size:255;notnull" json:"task_params"`
...
type ProxySpiderTask struct {
	gorm.Model
	SpiderIp       string     `gorm:"size:255;notnull" json:"spider_ip"`
	TaskType       string     `gorm:"size:255;notnull" json:"task_type"`
	TaskName       string     `gorm:"size:255;notnull" json:"task_name"`
	TaskId         string     `gorm:"size:255;notnull" json:"task_id"`
	...
	ResultFileMd5  string     `gorm:"size:255" json:"result_file_md5"`
}
