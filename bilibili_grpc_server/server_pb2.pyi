...
class userInfo(_message.Message):
    ...
    lastHistoryTime: int
    lastUpdateTime: int
    def __init__(self, cookies: _Optional[_Mapping[str, str]] = ..., lastHistoryTime: _Optional[int] = ..., lastUpdateTime: _Optional[int] = ...) -> None: ...

class videoInfoResponse(_message.Message):
    __slots__ = ("title", "desc", "cover", "uid", "duration", "updateTime", "tags", "classify", "viewNumber", "danmaku", "reply", "favorite", "coin", "share", "nowRank", "hisRank", "like", "dislike", "evaluation", "authors", "viewInfo", "webSiteName", "errorCode", "errorMsg")
...
class AuthorInfoResponse(_message.Message):
    ...
    errorCode: int
    errorMsg: str
    def __init__(self, author: _Optional[str] = ..., name: _Optional[str] = ..., avatar: _Optional[str] = ..., desc: _Optional[str] = ..., uid: _Optional[str] = ..., followNumber: _Optional[int] = ..., errorCode: _Optional[int] = ..., errorMsg: _Optional[str] = ...) -> None: ...
...
class getVideoListRequest(_message.Message):
    ...
    userInfo: userInfo
    videoIdList: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, userInfo: _Optional[_Union[userInfo, _Mapping]] = ..., videoIdList: _Optional[_Iterable[str]] = ...) -> None: ...
